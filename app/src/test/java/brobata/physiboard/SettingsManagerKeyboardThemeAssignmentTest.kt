...
import brobata.physiboard.backup.PreferenceSchemas
import brobata.physiboard.backup.PreferenceValueType
    ...
    fun keyboardThemeAssignmentPreferences_areRecognizedForRestore() {
        listOf(
            ...
            assertEquals(
                ...
                PreferenceSchemas.expectedType(brobata.physiboard.SettingsMigration.PREFS, key)
            )
        }
    }
