...
class SettingsManagerLayoutSwitchTest {
    ...
    fun autoSpacePunctuation_legacyStoredDefaultWithoutSemicolonStaysWithoutSemicolon() {
        val context = RuntimeEnvironment.getApplication()
        context.getSharedPreferences(brobata.physiboard.SettingsMigration.PREFS, android.content.Context.MODE_PRIVATE)
            .edit()
    ...
    fun initializeNavModeMappings_migratesEmptyCtrlBToKeyboardModeToggle() {
        ...
        val mappings = brobata.physiboard.data.mappings.KeyMappingLoader.loadCtrlKeyMappings(context.assets, context)
        assertEquals(
        ...
        assertEquals(
            brobata.physiboard.data.mappings.KeyMappingLoader.CtrlMapping("action", "custom_action"),
    ...
    fun saveNavModeKeyMappings_preservesCommandMappings() {
        ...
        assertEquals(
            brobata.physiboard.data.mappings.KeyMappingLoader.CtrlMapping("command", "device.home"),
