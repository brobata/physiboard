...
import brobata.physiboard.SettingsManager.KeyboardThemeTarget
...
class HardwareBarHeightMigrationTest {
    ...
    private val prefs = context.getSharedPreferences(brobata.physiboard.SettingsMigration.PREFS, 0)
