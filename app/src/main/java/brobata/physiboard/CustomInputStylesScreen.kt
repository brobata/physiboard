...
import brobata.physiboard.dictionaries.InstalledDictionariesActivity
...
private fun hasDictionaryForLocale(context: Context, locale: String): Boolean {
    try {
        ...
        try {
            if (brobata.physiboard.core.suggestions.DictionaryStore.resolve(context, langCode) != null) {
                return true
            }
        } catch (e: Exception) {
