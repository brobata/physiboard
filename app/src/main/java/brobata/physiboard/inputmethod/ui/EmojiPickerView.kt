...
import brobata.physiboard.data.emoji.EmojiRepository
import brobata.physiboard.data.emoji.RecentEmojiManager
import brobata.physiboard.data.emoji.EmojiSearchRepository
...
class EmojiPickerView(
    ...
    fun configureSoftwareKeyboardMode(heightPx: Int?, onKeyboardLayoutRequested: (() -> Unit)?) {
        val configuredHeight = if (brobata.physiboard.SettingsManager.getEmojiPickerExpandedHeight(context)) {
