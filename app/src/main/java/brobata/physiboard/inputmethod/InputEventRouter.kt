...
import brobata.physiboard.core.SymLayoutController.SymKeyResult
...
import brobata.physiboard.data.layout.isRealMultiTap
...
class InputEventRouter(
    ...
    var suggestionController: brobata.physiboard.core.suggestions.SuggestionController? = null
    ...
    fun handleTextInputPipeline(
        ...
        inputContextState: brobata.physiboard.core.InputContextState?,
        ...
        val boundarySet = brobata.physiboard.core.Punctuation.BOUNDARY
        ...
        if (inputContextState != null && enableShiftOneShot != null) {
            val shouldCap = brobata.physiboard.inputmethod.AutoCapitalizeHelper.shouldCapitalizeAfterBoundary(
                context = context,
        ...
        if (isEnterKey) {
            ...
            var replaceResult: brobata.physiboard.core.suggestions.AutoReplaceController.ReplaceResult? = null
        ...
        if (
            ...
            brobata.physiboard.core.Punctuation.commitFrenchSpacedPunctuation(inputConnection, typedChar)
        ) {
            suggestionController?.onContextReset()
            return true
        }
