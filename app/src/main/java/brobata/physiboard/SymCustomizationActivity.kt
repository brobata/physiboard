...
class SymCustomizationActivity : LocalizedComponentActivity() {
    companion object {
        const val EXTRA_INITIAL_PAGE = "brobata.physiboard.extra.INITIAL_SYM_PAGE"
        const val EXTRA_INITIAL_KEY_CODE = "brobata.physiboard.extra.INITIAL_SYM_KEY_CODE"
        const val EXTRA_OPEN_PICKER = "brobata.physiboard.extra.OPEN_SYM_PICKER"
        const val EXTRA_RETURN_AFTER_PICKER = "brobata.physiboard.extra.RETURN_AFTER_PICKER"
    }
